                              ...
                              >
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-sm text-gray-400">
                                    A smart GPT catered towards students aiming
                                    to break into tech
                                  </div>
                                </div>
                              </a>
                            ...
                            <div className="space-y-3">
                              ...
                              >
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="text-sm text-gray-400">
                                    Data-driven insights and real-time
                                    dashboards
                                  </div>
                                </div>
                              </a>
                    ...
                    >
                      ...
                      <div className="col-span-5">
                        <div className="space-y-3">
                          ...
                          >
                            <div className="font-medium mb-1 hover:text-[#048304] transition-colors">
                              Our Mission
                            </div>
                            <div className="text-sm text-gray-400">
                      ...
                      <div className="col-span-4 border-l border-gray-800/30 pl-8">
                        ...
                        <a href="#" className="block group/article">
                          ...
                          <p className="text-sm text-gray-400 mb-3">
                            Discover how students are sharing what they've
                            learnt through Dijkstra blog...
                          </p>
          ...
          <div className="text-center mb-20">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Dijkstra is a one-stop, open-source platform for aspiring
                Software Engineers to prepare and crack jobs in today’s
              ...
              <div className="h-full bg-gradient-to-b from-gray-900 to-gray-950 p-[1px] rounded-xl">
                <div className="h-full bg-gradient-to-b from-gray-900 to-gray-950 p-8 rounded-xl border border-gray-800/50 hover:border-green-500/30 transition-all duration-300">
                  ...
                  <Button
                    ...
                    className="w-full mb-8 bg-gray-800 hover:bg-gray-700 text-white"
                  >
                    Get Started
                  </Button>
                  ...
                  <div className="space-y-4">
                    ...
                    {["Dijkstra Predictive Ranking", "Stats Aggregation"].map(
                      (feature, i) => (
            ...
            >
              <div className="h-full bg-gradient-to-b from-gray-900 to-gray-950 p-[1px] rounded-xl">
                <div className="h-full bg-gradient-to-b from-gray-900 to-gray-950 p-8 rounded-xl border border-gray-800/50 hover:border-green-500/30 transition-all duration-300">
                  ...
                  <Button className="w-full mb-8 bg-gray-800 hover:bg-gray-700 text-white">
                    Contact Sales
                  </Button>
          ...
          <div className="grid lg:grid-cols-[1fr_auto_1fr] gap-20 items-start">
            ...
            >
              <h2 className="text-5xl md:text-6xl font-bold tracking-tight mb-6 text-gray-900 dark:text-white">
                Building Incredible Software <br />
                For Students, <br />
                By Students.
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-12 leading-relaxed max-w-xl">
                ...
                . Changing the future of CS Education in India. So, Ready to Get
                Started?
              </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div>
              ...
              <p className="text-gray-400 mb-6">
                Building <span className="text-white">Incredible Software</span>{" "}
                <br />
                For <span className="text-white">Students</span>, <br />
                By <span className="text-white">Students</span>.
              </p>
